...
if SEL == 1:
	...
	ers_r    = 5						# Sphere relative permittivity (real part)
	ers_i    	= -2                		# Sphere relative permittivity (imag part)
	mrs_r 	= -4                		# Sphere relative permeability (real part)
	mrs_i   	= -6                		# Sphere relative permeability (imag part)
...
if SEL == 3:
	...
	mrs_r	= -4						# Sphere relative permeability (real part)
	mrs_i	= -6						# Sphere relative permeability (imag part)
	rstart	= 1e-9					# Smallest sphere radius [m]
	rstop 	= 500e-9 				# Largest sphere radius [m]
...
if SEL == 4:
	...
	mrs_r	= -4						# Sphere relative permeability (real part)
	mrs_i	= -6						# Sphere relative permeability (imag part)
	wstart	= 400e-9				# Smallest wavelength [m]
	wstop 	= 10000e-9			# Largest wavelength [m]
	npts 		= 1000					# Number of steps between wstart and wstop
...
if int(sys.argv[1]) != 1:
	...
	if SEL == 1:
		system("./Mie " + str(SEL) + " " + str(lam) + " " + str(n) + " " + str(r) + " " + str(ers_r) + " " + str(ers_i) + " " + str(mrs_r) + " " + str(mrs_i) + " " + str(Lx) + " " + str(Ly) + " " + str(Lz) + " " + str(Cx) + " " + str(Cy) + " " + str(Cz) + " " + str(res) + " " + fname)
	if SEL == 2:
		system("./Mie " + str(SEL) + " " + str(lam) + " " + str(n) + " " + str(r) + " " + str(ers_r) + " " + str(ers_i) + " " + str(mrs_r) + " " + str(mrs_i) + " " + str(R) + " " + str(res) + " " + fname)
	if SEL == 3:
		system("./Mie " + str(SEL) + " " + str(lam) + " " + str(n) + " " + str(ers_r) + " " + str(ers_i) + " " + str(mrs_r) + " " + str(mrs_i) + " " + str(rstart) + " " + str(rstop) + " " + str(npts) + " " + fname)
	if SEL == 4:
		system("./Mie " + str(SEL) + " " + str(r) + " " + str(n) + " " + str(ers_r) + " " + str(ers_i) + " " + str(mrs_r) + " " + str(mrs_i) + " " + str(wstart) + " " + str(wstop) + " " + str(npts) + " " + fname)
	if SEL == 5:
		system("./Mie " + str(SEL) + " " + str(lam) + " " + str(n) + " " + str(r) + " " + str(ers_r) + " " + str(ers_i) + " " + str(mrs_r) + " " + str(mrs_i) + " " + str(R) + " " + str(res) + " " + str(plane) + " " + fname)
...
if SEL == 3:
	...
	plot(2*pi/lam*rv, Cext/(pi*rv**2), linewidth = 2, color='red', label='Cext')
	plot(2*pi/lam*rv, Cabs/(pi*rv**2), linewidth = 2, color='blue', label='Cabs')
	xlabel("$k r$")
	ylabel("$\sigma/(\pi r^2)$")
	grid()
	legend()
...
if SEL == 4:
	...
	plot(2*pi/wv*r, Cext/(pi*r**2), linewidth = 2, color='red', label='Cext')
	plot(2*pi/wv*r, Cabs/(pi*r**2), linewidth = 2, color='blue', label='Cabs')
	xlabel("$k r$")
	ylabel("$\sigma/(\pi r^2)$")
	grid()
	legend()
